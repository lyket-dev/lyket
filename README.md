...
This monorepo is setup for a dummy `@lyket/` NPM organization. There are 2 packages by default:

- `@lyket/react` - A placholder React component
- `@lyket/utils` - A utils packages

Unlike other TSDX templates, the developer experience for this template is currently a bit more manual.

Your first order of business will be to search and replace `@lyket` for the npm organization of your own.
